...
ClusterA_I = rbind(ClusterA1_I,ClusterA2_I,ClusterA3_I)
 ClusterA_I$Int_Clust = c("Low_Value","Medium_Value","High_Value") 
ClusterA_I$colors <- c("#d35400", "#2980b9", "#2ecc71")
...
df = x1[,c("InvoiceDate","Cost")]   # A data frame with columns ds & y (datetimes & metrics)
colnames(df) = c("ds","y")
